...
| 공통 명세 | `V2-DOC-001` | 요구·기능·화면·QA·롤백·기능 제안 템플릿, C0 기록 완전성 gate | **기획 미리보기** `S-01/S-04/S-08/S-10/S-09` | `QA-PLN-001`: 실제 선택지 35개·한 번에 결정 하나·명시적 다음 버튼·필수 메모·무저장 검토안 복사·새로고침 초기화·light/dark 보조·상태 문자 4.5:1·동일 origin GET·위험 버튼 비활성·320px 모든 결정 10,000px 이하·5화면+추적표 PNG·source SHA·clean 여부·소스/PNG digest manifest·mobile 표 헤더 접근성·desktop/mobile 가로 넘침 0. C0 gate 양성/음성 51건 | 현재 후보 로컬 review board 2/2·C0 gate 51/51 PASS. 이 변경의 CI는 PR #57 checks에서 확인. 이전 기능 후보 `1520166`: [push CI 30959376884](https://github.com/ksi2564/systematic-trading/actions/runs/30959376884)와 당시 test-merge `5fca72e`: [PR CI 30959379072](https://github.com/ksi2564/systematic-trading/actions/runs/30959379072) planning artifact PASS | [상세 QA 판정](TRACEABILITY_QA.md) | 부분 | D-01~D-10 검토 |
