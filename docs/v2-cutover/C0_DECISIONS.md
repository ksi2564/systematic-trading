...
| Java를 멈췄나 | 서비스·PID는 중단하지 않았음. 실제 전략 on/off·최근 스케줄 성공·주문 모드는 C0-B 확인 대기 |
...
- C0-A 뒤 C2 시작 전에 Java SHA·effective 설정·최신/직전 전략 상태의 checksum을 읽기
  전용으로 고정한다.
...
합친 기준 tree digest
`ba25e6d6dc2dd4b0c05e3a3dbd51de221280cc5cb7dd5ca462787c7f0ea36acb`와 현재 tree를
