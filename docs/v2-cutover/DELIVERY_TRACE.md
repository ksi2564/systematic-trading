...
| D-07 | `V2-QA-001` | QA 기록 묶음·정리 tombstone·GET-only 배포 화면 harness | `S-03`, `S-08` | `QA-NAV-001`, `QA-OPS-001`, `QA-RWD-001`, `QA-SAF-001`: 로컬 가상 데이터 화면·증적 경계만 검증. 상태를 바꾸는 `QA-OPS-002`, `QA-MAN-001~009` 위험 작업과 `QA-ACC-002` 인증 화면은 모두 미실행 | 기능 후보 `1520166`: clean-tree 26/26·증적 참조 78개 SHA-256 검증·리소스 변경 0과 [push CI 30959376884](https://github.com/ksi2564/systematic-trading/actions/runs/30959376884) artifact PASS; 당시 test-merge `5fca72e`: [PR CI 30959379072](https://github.com/ksi2564/systematic-trading/actions/runs/30959379072) artifact PASS. `MANUAL` 9·`BLOCKED` 2·`OUT_OF_SCOPE` 1은 통과로 올리지 않음 | [자동·수동 QA 경계](TRACEABILITY_QA.md#4-사용자에게-남길-수동-전용-시나리오) | 부분 | 승인 배포 SHA·사용자 준비 로그인 storage |
...
| C1 현재 UI | `V2-UI-001`, `V2-OPS-001` | 현재 6개 화면, 안전 상태 `checking/verified/unsafe/unavailable` | 현재 운영 콘솔(S-01 일부·S-02·S-03·S-05·S-06·S-07) | `QA-NAV-001`, `QA-OPS-001`, `QA-SAF-001`, `QA-RWD-001`: **현재 구현 화면** desktop/mobile mock 후보 | 기능 후보 `1520166`: clean-tree 26/26·[push CI 30959376884](https://github.com/ksi2564/systematic-trading/actions/runs/30959376884) `ui-qa` PASS; 당시 test-merge `5fca72e`: [PR CI 30959379072](https://github.com/ksi2564/systematic-trading/actions/runs/30959379072) `ui-qa` PASS. 운영 배포·인증 화면은 미실행 | [현재 UI QA 범위](TRACEABILITY_QA.md) | 부분 | 동일 SHA 배포·인증 QA |
